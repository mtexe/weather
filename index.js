...
app.post("/", function(req, res) {
    ...
    // takes in the zip from the html form, display in // console. Takes in as string, ex. for zip 02139
        var longitude = String(req.body.longi);
        console.log(req.body.longi);

        var latitude = String(req.body.lati);
        console.log(req.body.lati);
    
    //build up the URL for the JSON query, API Key is // secret and needs to be obtained by signup 
        const units = "imperial";
        const apiKey = "c0e9b38b30e3cd33c92699d39c1030c4";
    ...
    https.get(url, function(response){
        ...
        response.on("data", function(data){
            ...
            res.write("<h2>The icon is " + icon + " and the humidity is " + humidity + "%");
            res.write("<h2>The wind speed is " + speed + " miles per hour and the cloudiness is " + clouds + "%");
